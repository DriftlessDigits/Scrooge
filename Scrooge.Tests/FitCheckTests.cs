...
/// <summary>
/// The fit check at the round's press (WALK unit 8). The contract: two MEASURED
...
public class FitCheckTests
{
  ...
  {
    // Drift's example: a 20m pinch into a return well under it.
  ...
  public void BoardFresh_SkipsThePinch_ClocksMoot()
  {
    ...
    Assert.False(fit.RequiresConfirm);
    Assert.Contains("skips the re-check", fit.Message);
  }
