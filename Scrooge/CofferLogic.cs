...
/// <summary>
/// The Venture Coffer rider's PURE core (WALK, Drift's 2026-07-23 ruling: "if there
...
/// them - so the round opens ALL coffers at the FRONT of the bell stage (Drift's
/// 07-24 move: "then include them in the listing"), and the unlocked items land in
/// the bags in time for the bell's own re-route and re-scan to count them.
///
